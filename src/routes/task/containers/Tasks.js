...
import {fetch_tasks, delete_task, clear_message} from '../TaskActions'
        ...
        <div className="col-xs-12">
          ...
          <div className="box">
            <div className="box-body">
                ...
                <DatatableList id="taskList" options={options} formroute="edit/card" deleteevent={this.handleDelete.bind(this)}  >
                    <thead>
                        <tr>
